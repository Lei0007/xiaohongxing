...
则打印，“师弟！！！！”，如果传入“李秋水”，打印“呸，贱人”，如果传入“丁春秋”，打印“叛徒！我杀了你”
...
class TongLao:
    ...
    def see_people(self, name):
        ...
        if name == "WYZ":
            ...
            print(f"你的名字为: {self.name}")
    '''fight_zms方法（天山折梅手），调用天山折梅手方法会将自己的武力值提升10倍，血量缩减2倍。
          需要传入敌人的hp，power，进行一回合制对打，打完之后，比较双方血量。血多的一方获胜。'''
    def fight_zms(self,enemy_hp, enemy_power,enemy_name):
        self.enemy_hp = enemy_hp
        self.enemy_power = enemy_power
        self.enemy_name = enemy_name
        my_power = self.power*10-self.hp*2
        while True:
